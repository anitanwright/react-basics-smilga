...
const firstBook = {
  ...
  title: 'Atomic Habits',
  author: 'James Clear',
  authorPage: <a href='https://www.amazon.com/James-Clear/e/B07DJTJC3X/ref=dp_byline_cont_pop_book_1'>
...
function BookList() {
  return (
    <section className='booklist'>
      <Book img={firstBook.img} title={firstBook.title} author= {firstBook.author} authorPage= {firstBook.authorPage} />

      <Book img={secondBook.img} title={secondBook.title} author= {secondBook.author} authorPage= {secondBook.authorPage}/>
